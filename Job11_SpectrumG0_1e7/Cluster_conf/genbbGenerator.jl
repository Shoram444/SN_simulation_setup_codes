...
const NEVENTS     = 100_000  # how many events should be created
...
function main()
    inFile = string("/pbs/home/m/mpetro/Projects/PhD/Codes/Job10_SpectrumG0-cluster/spectrumG0_Rebinned_prec0001.csv")
