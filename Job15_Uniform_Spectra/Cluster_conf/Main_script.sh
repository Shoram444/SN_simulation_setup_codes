...
## ABSOLUTE LINKING:
	...
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job15_Uniform_Spectra/Cluster_conf
...
## END LINKING
	...
	do
		...
		then
    		...
    		cp $CONF_FOLDER/Angular_Corellation_esc_vs_emi.cpp $MAIN_FOLDER/$USER_FOLDNAME/$i/
			...
			sed -e "s|%i|$i|g" \
				$CONF_FOLDER/variant.profile > $MAIN_FOLDER/$USER_FOLDNAME/$i/variant_$i.profile # change event_input_%i in variant_%i.profile 
