...
## ABSOLUTE LINKING:
	...
	MAIN_FOLDER=/sps/nemo/scratch/mpetro/Projects/PhD/Cluster/Data/82Se_kappas
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job17_compareAngDist/Cluster_conf_Combination
...
## SPECIFY KAPPAS!!
	...
	KAPPA_SIGN=minus
	KAPPA_MIN=0.6639    # included
	KAPPA_MAX=0.6639    # exluded
	KAPPA_STEP=0.01
		...
		# k=0
			...
			do
				...
				then
		    		...
		    		cp $CONF_FOLDER/Job16.cpp $MAIN_FOLDER/$USER_FOLDNAME/$k/$i/
