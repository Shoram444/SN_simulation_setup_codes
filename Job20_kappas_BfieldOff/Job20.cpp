// Mi headers
#include "/pbs/home/m/mpetro/PROGRAMS/MiModule_test/include/MiEvent.h"      //I have modified the MiModule from what's in github, 
#include "/pbs/home/m/mpetro/PROGRAMS/MiModule_test/include/MiSDVisuHit.h"  //there are a few additional variables that are used here, like getMomentumStart()
#include "/pbs/home/m/mpetro/PROGRAMS/MiModule_test/include/MiFilters.h"    

#include "TLatex.h"
#include "TVector3.h" //I use this just for convenience as it implements the Angle method, but that's just a scalar product of 2 vectors, you can make your own implementation if you want
...
/////////////////////////////////////////////////////////////
	const char* inFileName                 = "Default.root";					//name of input								 //FOR TESTING PURPOSES USING ONLY FOLDER 0/
	const char* outPathAngularCorrelation  = "MomPosEneThetaPhi_1e6pf.root";    //name of output
