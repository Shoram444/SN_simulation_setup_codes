...
const NEVENTS     = 10_001 #   how many events should be created +1
const FILENAME    = "input_module.genbb" # name of the output file
const INFILENAME  = "%CONF_FOLDER/xi51_0.1397-xi31_0.37-K2v_-0.6639-G0_G2_G22_G4.csv" # name of the input file - spectrum
const PROCESS     = "82Se 2νββ - Uniform spectra, uniform angular distributions"
const MAXENERGY   = 3.5
