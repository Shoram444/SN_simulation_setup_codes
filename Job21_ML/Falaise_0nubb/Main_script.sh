...
## ABSOLUTE LINKING:
	...
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job21_ML/Falaise_0nubb
...
## END LINKING
	...
	do
		...
		then
    		...
    		cp $CONF_FOLDER/0nubb.conf $MAIN_FOLDER/$USER_FOLDNAME/$f/
			cp $CONF_FOLDER/0nubb.profile $MAIN_FOLDER/$USER_FOLDNAME/$f/
