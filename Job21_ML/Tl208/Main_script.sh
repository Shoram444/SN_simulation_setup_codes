...
## ABSOLUTE LINKING:
	...
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job21_ML/Tl208
...
## END LINKING
	...
	do
		...
		then
    		...
    		cp $CONF_FOLDER/Tl208.conf $MAIN_FOLDER/$USER_FOLDNAME/$f/
			cp $CONF_FOLDER/Tl208.profile $MAIN_FOLDER/$USER_FOLDNAME/$f/
