...
## ABSOLUTE LINKING:
	...
	FAL=/pbs/home/m/mpetro/sps_mpetro/PROGRAMS/Falaise5.1.2/build/BuildProducts/bin
	JULIA=/sps/nemo/scratch/mpetro/PROGRAMS/julia/juliaup/julia-1.10.0+0.x64.linux.gnu/bin
	MAIN_FOLDER=/sps/nemo/scratch/mpetro/Projects/PhD/Cluster_sim_data
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job23_2nu_sensitivity/RH_K037
	RESOURCES=/sps/nemo/scratch/mpetro/PROGRAMS/Falaise/install/share/Falaise-4.0.3/resources/genbb
	ROOT_FOLDER=/sps/nemo/sw/BxCppDev/opt/root-6.16.00/bin

## SPECIFY KAPPAS!!

	KAPPA_SIGN=plus
	KAPPA_MIN=0.370    # included
	KAPPA_MAX=0.370    # exluded
	KAPPA_STEP=0.01
	KAPPA_N=1         # number of kappas to simulate over the specified range (if 1, only one spectrum will be simulated) 

	i=0  # CHANGE THIS WHEN ADDING TO ALREADY EXISTING SIMULATION!!
		...
		# k=0
			...
			do
				...
				then
    				...
    				cp $CONF_FOLDER/Job23.cpp $MAIN_FOLDER/$USER_FOLDNAME/$k/$i/
