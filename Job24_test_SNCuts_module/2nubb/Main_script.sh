...
## ABSOLUTE LINKING:
	...
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job24_test_SNCuts_module/2nubb
...
## END LINKING
	...
	do
		...
		then
    		...
    		cp $CONF_FOLDER/2nubb.conf $MAIN_FOLDER/$USER_FOLDNAME/$f/
			cp $CONF_FOLDER/2nubb.profile $MAIN_FOLDER/$USER_FOLDNAME/$f/
