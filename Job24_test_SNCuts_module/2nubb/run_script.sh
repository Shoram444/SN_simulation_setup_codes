...
#SBATCH --job-name=2nubb              	 # Job name
...
%FAL/flsimulate -c %MAIN_FOLDER/%USER_FOLDNAME/%f/2nubb.conf -o SD.brio 
...
cp EnePhiDist_Job23.root %MAIN_FOLDER/%USER_FOLDNAME/%f/EnePhiDistPos_Job23.root
