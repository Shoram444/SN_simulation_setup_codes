...
## ABSOLUTE LINKING:
	...
	MAIN_FOLDER=/sps/nemo/scratch/mpetro/Projects/PhD/Cluster/TestingSNCuts
	CONF_FOLDER=/pbs/home/m/mpetro/Projects/PhD/Codes/Job24_test_SNCuts_module/Pa234m
...
## END LINKING
	...
	do
		...
		then
    		...
    		cp $CONF_FOLDER/Job23.cpp $MAIN_FOLDER/$USER_FOLDNAME/$f/
    		cp $CONF_FOLDER/Pa234m.conf $MAIN_FOLDER/$USER_FOLDNAME/$f/
			cp $CONF_FOLDER/Pa234m.profile $MAIN_FOLDER/$USER_FOLDNAME/$f/
